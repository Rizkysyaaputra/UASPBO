...
public class ObatJFrame extends javax.swing.JFrame {
    ...
    private void CariData(){
        try {
            ...
            rs = st.executeQuery("SELECT * FROM tblobat WHERE "
    ...
    private void TampilData(){
        try {
            st = rizky.createStatement();
            rs = st.executeQuery("SELECT * FROM tblobat");
    ...
    private void initComponents() {
        ...
        tbldata.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "kode", "nama", "harga", "jenis", "stok", "kadaluarsa"
            }
        ));
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        ...
        try {
            ...
            if (btnsimpan.getText()=="Simpan") {
                ...
                String cek ="SELECT * FROM tblobat WHERE kode = '" + txtkode.getText()+"'";
                rs = st.executeQuery(cek);
                if (rs.next()) {
                    JOptionPane.showMessageDialog(null,"Kode Barang Sudah dipakai");
                }else{
                    //fungsi untuk menyimpan data ke tabel
                    String sql = "INSERT INTO tblobat VALUES('" + txtkode.getText()+
                            "','"+txtnama.getText() +
                            "','"+txtharga.getText() +
                            "','"+txtjenis.getText() +
                            "','"+txtstok.getText() +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ObatJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ObatJFrame().setVisible(true);
            }
        });
    }
